                    ...
                    <div className="w-full md:w-1/3 p-4">
                        <div className="flex items-center text-center">
                            ...
                            <div className="text-start ml-1">
                                ...
                                <p className="text-red-500">Experience</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 p-4">
                        <div className="flex items-center text-center">
                            ...
                            <div className="text-start ml-1">
                                <h3 className="text-xl font-bold mb-2">Fully Secured</h3>
                                <p className="text-red-500">Instantaneous payments</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-1/3 p-4">
                        <div className="flex items-center text-center">
                            ...
                            <div className="text-start ml-1">
                                ...
                                <p className="text-red-500">Online 24/7</p>
                            </div>
                        </div>
                    </div>
                </div>
