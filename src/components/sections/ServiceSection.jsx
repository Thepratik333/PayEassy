  ...
  const ServiceSection = () => {
    return (
      <section className="service-section h-[55vh]" id="services">
        <div className="container mx-auto px-4">
          <div className="text-center md:flex">
            <div className="service-title-container">
              ...
              <div className="service-btn-container animate__animated animate__fadeInUp flex justify-center space-x-4">
                <button
            ...
            <div className="swiper-container md:overflow-auto services-cont animate__animated animate__fadeInUp mt-8">
              <Swiper
                spaceBetween={20}
                slidesPerView={3}
                navigation={{
